      ...
      <div className="w-full lg:w-[480px] flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-[400px]">
          ...
          <p className="text-neutral-500 text-sm mb-6">
            Get started with Google, GitHub, or your work email
          </p>
          ...
          <div className="space-y-3 mb-6">
            <a
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 hover:border-neutral-600 text-white text-sm rounded-lg font-medium transition-all shadow-sm"
            >
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-neutral-100 text-black text-sm rounded-lg font-semibold transition-all shadow-sm"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 bg-teal-600 hover:bg-teal-500 text-white rounded-md text-sm font-medium disabled:opacity-50 transition-all"
            >
